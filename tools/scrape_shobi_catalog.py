...
Output: database/source/shobi-master-v1-refresh.csv, con le stesse colonne concettuali
...
def main():
    ...
    df.to_csv("database/source/shobi-master-v1-refresh.csv", index=False)
    print("Salvato in database/source/shobi-master-v1-refresh.csv")
