...
DB=Path('database/catalog/database_complete.json'); MASTER=Path('database/archive/catalog/shobi-master-v1.csv'); OUT=Path('database/audits/catalog-integrity-full-audit.md')
def norm(s):
