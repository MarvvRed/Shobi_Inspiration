...
MIS=json.loads((ROOT/'database/audits/fid-mismatch-yellows.json').read_text(encoding='utf-8'))
...
out={'rows':rows};(ROOT/'database/audits/fid-mismatch-gender-context.json').write_text(json.dumps(out,ensure_ascii=False,indent=2)+'\n',encoding='utf-8');print(json.dumps(out,ensure_ascii=False,indent=2))
