...
OUT=Path('database/audits/fragrantica-v2-brand-override-review.csv')
REPORT=Path('database/audits/fragrantica-v2-brand-override-review.md')
...
OVERRIDES={
 ...
 'JES':'Jesus Del Pozo',
 'ANFAD':'Anfasic',
 'GFE':'Gianfranco Ferre',
 'VERT':'Vertus',
 'LORV':'Lorenzo Villoresi',
 'PRFRO':'Profumum Roma',
 'SHIS':'Shiseido',
 'MICA':'M Micallef',
 'HAM':'Hamidi Oud',
...
# Expanded local-only override audit for clearly identified Shobi brand suffixes.
