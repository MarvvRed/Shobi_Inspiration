...
Tries Fragrantica's own public search page first, then falls back to the
existing free HTML search providers. No paid APIs or secrets are used.
"""
...
def search_web_direct_first(query: str):
    ...
    return (
        fallback,
        direct_provider + "," + fallback_provider,
        direct_errors + fallback_errors,
    )
