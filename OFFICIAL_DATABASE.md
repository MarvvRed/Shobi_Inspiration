...
- `database/catalog/database_final_perfume_only.json` — full final database: **2,257** certified Shobi perfume records, including product IDs and Shobi URLs.
- `database/catalog/catalog_final_perfume_only.json` — lightweight public projection of the same **2,257** records, loaded by the website.
