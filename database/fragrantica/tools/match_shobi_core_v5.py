...
CATALOG=Path(os.environ.get("SHOBI_MATCH_CATALOG", str(ROOT/"database/archive/catalog/shobi-master-v1.csv")))
CONFIRMED=ROOT/"database/archive/confirmed/shobi-fragrantica-mapping.csv"
URLS=ROOT/"database/fragrantica/legacy/original-local-scraper/perfume_urls.txt"
OUT=ROOT/"database/fragrantica/corpus-match"
