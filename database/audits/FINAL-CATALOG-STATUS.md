...
- `database/archive/catalog/shobi-master-v2-2369.csv`
- Rows: **2369**
...
The previous `database/archive/catalog/shobi-master-v1.csv` is retained unchanged as historical/source evidence. It is no longer the canonical current master. The backup branch `temporanea` remains untouched.
...
The canonical `inspiredBy` fields in `database/catalog/database_complete.json` were corrected and the former false same-name group `2783-LTN` / `2786-LTN` disappeared from the structural audit.
