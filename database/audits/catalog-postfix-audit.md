...
## Key codes
- `2514-DRC`: 1 row(s) — Dior — Sauvage Eau Forte — pid=4215
- `2282-DRC`: 1 row(s) — Dior — Dioriviera Eau de Parfum — pid=3915
- `2133-FRE`: 1 row(s) — Frédéric Malle — Lipstick Rose Eau de Parfum — pid=3567
...
## Same-name groups
- calvin klein — eternity: 470-CAL, 1044-CAL
- carolina herrera — 212 vip wild party: 483-CAR, 1057-CAR
- clinique — happy: 548-CLI, 1086-CLI
- dolce gabbana — light blue eau intense: 1872-DOL, 1096-DOL
- dolce gabbana — the one: 566-DOL, 1099-DOL
- gucci — guilty intense: 1866-GUC, 1146-GUC
